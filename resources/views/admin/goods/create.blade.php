...
@csrf
    ...
    <div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" id="firstname" name="goods_sn"
				   placeholder="请输入商品货号">
    ...
    <div class="form-group">
		...
		<div class="col-sm-2">
			<input type="radio" id="lastname" name="is_on_sale" value="1" checked>是
            <input type="radio" id="lastname" name="is_on_sale" value="2">否
		</div>
	</div>
	<div class="form-group">
		<label for="lastname" class="col-sm-2 control-label">首页幻灯推荐位</label>
		<div class="col-sm-2">
			<input type="radio" id="lastname" name="is_slice" value="1">是
            <input type="radio" id="lastname" name="is_slice" value="2" checked>否
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-10">
			<textarea type="text" class="form-control" name="content" id="lastname"></textarea>
            <b style="color:red">{{$errors->first('cate_content')}}</b>
		</div>
	</div>
	<div class="form-group">
